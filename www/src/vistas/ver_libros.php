...
<table cellspacing="0" cellpadding="0" class="sortable">
	...
	<tbody>
		...
		<tr>
			...
			<td><?php echo $valor['idioma']; ?></td>	
			<td>
				<a href="<?php echo CONTROL_HTML.'/ver_libro.php?id='.$valor['id']; ?>">
					<span class="tooltip" title="Ver libro">
						<i class="icon-2x icon-eye-open"></i>
					</span>
				</a>
				<a href="<?php echo CONTROL_HTML.'/editar_libro.php?id='.$valor['id']; ?>">
					<span class="tooltip" title="Editar libro">
						<i class="icon-2x icon-pencil"></i>
					</span>
				</a>
				<a href="<?php echo CONTROL_HTML.'/eliminar_libro.php?id='.$valor['id']; ?>">
